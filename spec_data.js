// 자바스크립트 백틱 충돌을 완벽히 방지한 문자열 빌드 구조
const REAL_ESTATE_SYSTEM_SPEC = 
...
+ "* [G/H/I] 통합 대시보드: 월세 총합/만기/갱신 시각화 판넬. 행별 메모장(`<input class=\"ledger-memo-input\">`) 변경 시 `onChange` -> `POST /api/v1/memos` 자동 기입 (R35).\n"
